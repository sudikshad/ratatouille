...
export function PageIllustration({ variant, className = "" }: PageIllustrationProps) {
  const baseClass = `pointer-events-none absolute bottom-0 left-0 right-0 opacity-[0.08] ${className}`;
  ...
  return (
    <g stroke="currentColor" strokeWidth="1.5" fill="none" strokeLinecap="round" strokeLinejoin="round">
      ...
      <g transform="translate(80, 60)">
        ...
        <path d="M25 25 Q40 15 55 25" />
        <path d="M40 20 L40 5" />
        <path d="M35 8 Q40 0 45 8" />
      </g>

      {/* Eggplant/Aubergine */}
      <g transform="translate(200, 30)">
        <path d="M30 20 Q60 20 60 60 Q60 120 40 140 Q20 160 20 120 Q0 80 0 60 Q0 20 30 20" />
        <path d="M20 20 Q30 0 40 10 Q50 0 55 15" />
        <path d="M30 15 L32 5" />
      </g>
      ...
      <g transform="translate(320, 40)">
        ...
        <path d="M15 30 Q20 10 25 15" />
        <path d="M20 30 Q25 5 30 12" />
        <path d="M25 30 Q32 15 35 22" />
      </g>
      ...
      <g transform="translate(660, 40)">
        ...
        <path d="M30 30 Q25 10 35 10 Q45 10 40 30" />
        <path d="M35 10 L35 0" />
  ...
  return (
    <g stroke="currentColor" strokeWidth="1.5" fill="none" strokeLinecap="round" strokeLinejoin="round">
      ...
      <g transform="translate(80, 40)">
        ...
        <path d="M10 55 L45 55" />
        <path d="M10 70 L50 70" />
        <path d="M70 40 L110 40" />
        <path d="M70 55 L105 55" />
        <path d="M70 70 L110 70" />
      </g>
      ...
      <g transform="translate(280, 50)">
        ...
        <path d="M10 35 L60 35" />
        <path d="M10 50 L65 50" />
        <path d="M10 65 L55 65" />
        <circle cx="60" cy="90" r="12" />
        <path d="M55 85 L60 90 L65 82" />
      </g>

      {/* Stack of books */}
      <g transform="translate(440, 60)">
        <rect x="0" y="80" width="100" height="15" rx="2" />
        <rect x="5" y="60" width="90" height="15" rx="2" />
        <rect x="0" y="40" width="95" height="15" rx="2" />
        <rect x="8" y="20" width="85" height="15" rx="2" />
        <path d="M20 80 L20 95" />
        <path d="M25 60 L25 75" />
        <path d="M18 40 L18 55" />
      </g>

      {/* Handwritten recipe */}
      <g transform="translate(620, 40)">
        <rect x="0" y="0" width="90" height="120" rx="2" />
        <path d="M10 20 Q25 18 40 20 Q55 22 70 20" />
        <path d="M10 35 Q30 33 50 35 Q65 37 80 35" />
        <path d="M10 50 Q20 48 35 50 Q50 52 60 50" />
        <path d="M10 65 Q35 63 55 65 Q70 67 80 65" />
        <path d="M10 80 Q25 78 45 80" />
        {/* Decorative curl */}
        <path d="M70 100 Q80 95 75 85 Q70 80 78 75" />
      </g>
  ...
  return (
    <g stroke="currentColor" strokeWidth="1.5" fill="none" strokeLinecap="round" strokeLinejoin="round">
      ...
      <g transform="translate(80, 20)">
        ...
        <path d="M55 30 L60 45" />
        <path d="M65 35 L70 50" />
      </g>
      ...
      <g transform="translate(240, 30)">
        ...
        <path d="M30 20 L60 20" />
        <path d="M10 40 L15 45 L25 35" />
        <path d="M30 40 L55 40" />
        <path d="M10 60 L15 65 L25 55" />
        <path d="M30 60 L50 60" />
        <circle cx="17" cy="80" r="6" />
        <path d="M30 80 L60 80" />
      </g>
      ...
      <g transform="translate(820, 50)">
        ...
        <path d="M15 35 Q40 25 65 35" />
        <path d="M10 50 Q40 40 70 50" />
      </g>

      {/* Jar */}
      <g transform="translate(960, 40)">
        <rect x="5" y="30" width="50" height="80" rx="5" />
        <rect x="10" y="20" width="40" height="15" rx="2" />
  ...
  return (
    <g stroke="currentColor" strokeWidth="1.5" fill="none" strokeLinecap="round" strokeLinejoin="round">
      ...
      <g transform="translate(620, 40)">
        ...
        {/* Whisk */}
        <path d="M70 50 L80 20 L85 0" />
        <path d="M75 35 Q85 40 80 50" />
        <path d="M78 30 Q88 32 85 42" />
      </g>
      ...
      <g transform="translate(1000, 50)">
        <path d="M0 30 L0 80 Q0 90 15 90 L35 90 Q50 90 50 80 L50 30" />
        <ellipse cx="25" cy="30" rx="25" ry="8" />
        <path d="M50 50 L65 50 L65 55 L50 55" />
        {/* Second smaller cup */}
        <path d="M70 50 L70 90 Q70 95 80 95 L95 95 Q105 95 105 90 L105 50" />
        <ellipse cx="87" cy="50" rx="18" ry="6" />
      </g>
    </g>
  );
}
